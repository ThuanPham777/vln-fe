...
export default function Footer({ settings }: HeaderProps) {
  const map_location = settings[ESettingKey.FOOTER]?.map_location ?? '';
  const footer_description =
    settings[ESettingKey.FOOTER]?.footer_description ?? '';
    ...
    <footer className='relative bg-black text-gray-300 pt-12 pb-8'>
      ...
      <div className='container mx-auto px-4 flex flex-wrap justify-between'>
        ...
        <div className='w-full md:w-1/3 lg:w-1/4 mb-8 md:mb-0 pr-4'>
          ...
          <p className='text-sm mb-4'>
            được biết đến là trung tâm giải trí game online uy tín nhất hiện
            nay. Ngoài việc chuyên cung cấp các dịch vụ giải trí online thì còn
            là nơi liên kết các thương hiệu nổi tiếng trên thế giới, tạo nên hệ
            thống game uy tín và chất lượng.
          </p>
          <div className='text-sm'>
            ...
            {/* Replace # with actual link */}
            <p className='mb-1'>Hotline: {phone}</p>{' '}
            {/* Replace with actual number */}
            <p className='mb-1'>Zalo: +855 92304903</p>{' '}
            {/* Replace with actual number */}
            <p className='mb-1'>Email: {gmail}</p>{' '}
            {/* Replace with actual email */}
          </div>
          {/* DMCA Protected Badge - Placeholder */}
          <div className='mt-4'>
            <img
              src='https://via.placeholder.com/100x30?text=DMCA+Protected'
              alt='DMCA Protected'
              className='h-8'
            />{' '}
            {/* Replace with actual badge */}
          </div>
        </div>
        ...
        <div className='w-full md:w-1/3 lg:w-1/3'>
          <h4 className='text-lg font-semibold text-white mb-4'>
            {' '}
            - LIÊN MINH GAME ONLINE UY TÍN NHẤT 2024
          </h4>{' '}
          {/* Map Title */}
          {/* Map Placeholder */}
          <div className='w-full h-64 bg-gray-700 rounded-lg overflow-hidden'>
            ...
            {/* Example: */}
            <iframe
              src={map_location} // REPLACE with the actual embed URL for your location
              width='100%'
              height='100%'
              style={{ border: 0 }}
      ...
      <div className='fixed bottom-6 right-4 flex flex-col space-y-3 z-50'>
        ...
        <a
          ...
          className='bg-green-500 p-3 rounded-full shadow-lg hover:bg-green-600 transition-colors duration-200'
        >
        ...
        <a
          ...
          target='_blank'
          rel='noopener noreferrer'
          className='bg-blue-500 p-3 rounded-full shadow-lg hover:bg-blue-600 transition-colors duration-200'
        >
        ...
        >
          ...
          <svg
            ...
            viewBox='0 0 24 24'
          >
            <path d='M12 0C5.373 0 0 5.152 0 12.161c0 5.053 3.104 9.34 7.5 11.164V14.81H4.539V12.16H7.5V9.954c0-3.062 1.772-4.724 4.576-4.724 1.31 0 2.569.234 2.569.234v2.81H13.27c-1.501 0-1.972.931-1.972 1.893v2.247h3.232l-.518 2.65H11.3V23.325C16.886 21.23 20.5 16.96 20.5 12.161 20.5 5.152 15.127 0 12 0z' />
          </svg>
        </a>
